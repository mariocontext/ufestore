...
<div class="ccm-dashboard-inner">
	...
	deleteAttribute = function() {
		if (confirm('<?php  echo $delConfirmJS?>')) { 
			location.href = "<?php  echo $this->url('/dashboard/core_commerce/products/attributes', 'delete', $key->getAttributeKeyID(), $valt->generate('delete_attribute'))?>";				
		}
	}
	</script>
...
<h1><span><?php  echo t('Add Attribute')?></span></h1>
<div class="ccm-dashboard-inner">
